...
<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM  pessoa_fisica WHERE id_pf LIKE '%$data%' or nome_pf LIKE '%$data%'  ORDER BY id_pf DESC";
    }
    else
    {
    $sql = "SELECT * FROM  pessoa_fisica ORDER BY id_pf DESC";
    }
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while($consulta_usuario = mysqli_fetch_assoc($result))
                {
                    ...
                    echo "<td>";
                    echo '<a class="btn-edit btn btn-sm btn-warning" href="editaPf.php?id_pf=' . $consulta_usuario["id_pf"] . '">Editar</a>';
                    echo "</td>";
                    echo "</tr>";
...
<script>
    ...
    function searchData()
    {
        window.location = 'listaClientePf.php?search='+search.value;
    }   
</script>
</html>