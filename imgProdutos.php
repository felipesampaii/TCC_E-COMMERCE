<!--imagnes e preço dos produtos-->
<?php
//variavel consulta  vai receber  variavel $mysql que é a variavel da conexão com o banco de dados na pg conexão.php
$consulta = $mysqli->query('select imagem_produto, nome_produto, preco_produto, quantidade_produto from produto');
?>
...
<div class = "container-fluid">
  ...
  <?php   while($exibe = $consulta->fetch_assoc()){  ?>
    <div class = "col-sm-3">
      ...
      <img src = "foto_produto/camera/<?php echo trim($exibe['imagem_produto']); ?>.jpg" class = "img-responsive" style =   "width:100%"> <!--TRIM remove todos os possiveis espaços que podem atrapalhar o código-->
